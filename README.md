...
Take a look at the example personalities in the `/cmd/` directory:
  ...
  - [objstore](./cmd/conformance/objstore/): example of operating a log running on any gocloud.dev/blob object store (GCS, AWS or other S3-compatible object stores) coordinated by MySQL.
